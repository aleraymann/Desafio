...
<div class="form-group text-left">
    ...
    <input type="text" class="form-control" id="title" name="title" placeholder="Product title" value="<?php echo e(old('title')); ?>">
</div>
<div class="form-group text-left">
...
<div class="form-group text-left">
    ...
    <input type="text" class="form-control col-md-1" id="price" name="price" value="<?php echo e(old('price')); ?>">
</div>
<div class="form-group text-left">
