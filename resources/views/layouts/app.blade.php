            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i><u>
                                <img src="/img/you.png"> {{ Auth::user()->name }} </i></u><span class="caret"></span>
                    </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="nav-item dropdown-item" href="{{ url('/products') }}"><img src="/img/list.png">
                            Product List</a>
                        <a class="nav-item dropdown-item" href="{{ url('/newProduct') }}"><img src="/img/add.png"> New
                            Product</a>
                    </div>
                </li>
            </ul>
