...
class User_seeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert(
            ["name"=> "Maria", "email"=> "maria@gmail.com", "password"=> bcrypt("123456789"), "city"=> "ivaipora", "state"=>"Paraná","posta_code"=>"84235485", "address"=>"juiz de fora", "number"=>76, "complement"=>"casa fundos", "district"=>"Brasil" ]);
    }
}